...
from app.ui.pages.agent_console import agent_console_page
...
from app.ui.states.conversation_state import ConversationState
...
app.add_page(
    agent_console_page,
    route="/agent-console",
    on_load=sidebar_load_events + [ConversationState.load_conversations],
)
