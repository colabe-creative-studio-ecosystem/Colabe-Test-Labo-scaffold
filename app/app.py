...
from app.ui.pages.outbound_messaging import outbound_messaging_page
...
from app.ui.states.outbound_messaging_state import OutboundMessagingState
...
app.add_page(
    outbound_messaging_page,
    route="/outbound-messaging",
    on_load=sidebar_load_events + [OutboundMessagingState.load_dashboard],
)
