...
def upgrade() -> None:
    ...
    op.create_table('projectpolicy',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('project_id', sa.Integer(), nullable=False),
    sa.Column('blocking_severity', sa.Enum('CRITICAL', 'HIGH', 'MEDIUM', 'LOW', name='severityenum'), nullable=False),
    ...
    sa.Column('required_adapters', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('autofix_scope', sa.Enum('SECURITY', 'QUALITY', 'ALL', 'NONE', name='autofixscopeenum'), nullable=False),
    ...
    sa.Column('role', sa.Enum('OWNER', 'ADMIN', 'DEVELOPER', 'VIEWER', name='roleenum'), nullable=False),
    sa.ForeignKeyConstraint(['project_id'], ['project.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('autofixrun',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('componentvulnerability',
    sa.Column('id', sa.Integer(), nullable=False),
